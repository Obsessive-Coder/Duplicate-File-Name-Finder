...
Partial Class frmMainForm
    ...
    Private Sub InitializeComponent()
		...
		Me.btnScan.Font = New System.Drawing.Font("Microsoft Sans Serif", 28.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
		...
		Me.cbxFileExtension.Items.AddRange(New Object() {"*", ".CRP", ".AIFF", ".AIF", ".AU", ".AVI", ".BAT", ".BMP", ".CLASS", ".JAVA", ".CSV", ".CVS", ".DBF", ".DIF", ".DOC", ".DOCX", ".EPS", ".EXE", ".FM3", ".GIF", ".HQX", ".HTM", ".HTML", ".JPG", "JPEG", ".MAC", ".MAP", ".MDB", ".MID", ".MIDI", ".MOV", ".MP3", ".QT", ".MTB", ".MTW", ".PDF", ".P65", ".T65", ".PNG", ".PPT", ".PPTX", ".PSD", ".PSP", ".QXD", ".RA", ".RTF", ".SIT", ".TAR", ".TIF", ".TXT", ".WAV", ".WK3", ".WKS", "WPD", ".WP5", ".XLS", ".XLSX", ".ZIP"})
